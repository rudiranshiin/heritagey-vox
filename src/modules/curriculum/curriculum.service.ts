  ...
  async createScenario(data: CreateScenarioDto) {
    const scenario = await prisma.scenario.create({
      data: {
        ...
        practiceActivities: JSON.parse(JSON.stringify(data.practiceActivities)),
        culturalInsights: JSON.parse(JSON.stringify(data.culturalInsights)),
        grammarNotes: JSON.parse(JSON.stringify(data.grammarNotes)),
        commonMistakes: JSON.parse(JSON.stringify(data.commonMistakes)),
        successCriteria: JSON.parse(JSON.stringify(data.successCriteria)),
        order: data.order,
      },
    });
